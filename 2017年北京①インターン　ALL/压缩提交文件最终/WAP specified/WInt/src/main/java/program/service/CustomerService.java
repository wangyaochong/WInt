...
public class CustomerService {
    ...
    public Page<Customer> queryPage(Customer queryExample, Integer pageNum, Integer pageSize, String orderBy, Boolean OrderAsc){
        ...
        if(StringUtils.isNullOrEmpty(orderBy)){//如果不排序
            ...
            return customerRepo.findAll( Example.of(queryExample,ExampleMatcher.matching()
                    .withStringMatcher(ExampleMatcher.StringMatcher.CONTAINING)
                    .withIgnoreCase()),
